...
We refer to the publicly provided docker image but if you [built your own](docs/devel.adoc) replace `gosecure/pyrdp` with the name of your locally built image.
